...
@pytest.mark.asyncio
async def test_create_submenu(test_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_submenus(test_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_submenu_detail(test_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_patch_submenu(test_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_delete_submenu(test_client: AsyncClient) -> None:
