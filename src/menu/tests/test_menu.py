...
@pytest.mark.asyncio
async def test_create_menu(test_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_menus(test_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_menu_detail(test_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_get_full_menu(test_client: AsyncClient) -> None:
    ...
    await test_client.post(f'/menus/{DATA_SUBMENU["menu_id"]}/submenus/{DATA_SUBMENU["id"]}/dishes',
                           json=DATA_DISH)
    response: Response = await test_client.get('/menus/full')
    response_json: dict = response.json()
...
@pytest.mark.asyncio
async def test_patch_menu(test_client: AsyncClient) -> None:
