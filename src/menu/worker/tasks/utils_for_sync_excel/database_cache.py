...
def create_menu_service(session: Session, offline_menu: MenuModel, cache: CacheRedis = CacheRedis()) -> None:
    cache.delete_cache(['get_menus'])
    create_menu(session, offline_menu)


def update_menu_service(session: Session, offline_menu: MenuModel, cache: CacheRedis = CacheRedis()) -> None:
    cache.delete_cache(['get_menus',
                        f'menu:{offline_menu.id}'])
    update_menu(session, offline_menu)


def update_submenu_service(session: Session, offline_submenu: SubmenuModel, cache: CacheRedis = CacheRedis()) -> None:
    cache.delete_cache([
...
def create_submenu_service(session: Session, offline_submenu: SubmenuModel, cache: CacheRedis = CacheRedis()) -> None:
    cache.delete_cache([
...
def update_dish_service(session: Session, offline_dish: Any, cache: CacheRedis = CacheRedis()) -> None:
    cache.delete_cache([
...
def create_dish_service(session: Session, offline_dish: Any, cache: CacheRedis = CacheRedis()) -> None:
    cache.delete_cache([
